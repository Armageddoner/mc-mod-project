...
import net.wildage.thatsyourmod.event.ModEvents;

// The value here should match an entry in the META-INF/neoforge.mods.toml file
@Mod(ThatsYourDecisionMod.MODID)
public class ThatsYourDecisionMod {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "thatsyourdecisionllc";
    ...
    public ThatsYourDecisionMod(IEventBus modEventBus, ModContainer modContainer) {
