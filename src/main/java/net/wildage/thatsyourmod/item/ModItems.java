...
public class ModItems {
    ...
    public static final DeferredItem<Item> REGREIUM_HELMET = ITEMS.register("regreium_helmet", () -> new ArmorItem(Holder.direct(ModArmorMaterials.REGREIUM), ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> REGREIUM_CHESTPLATE = ITEMS.register("regreium_chestplate", () -> new ArmorItem(Holder.direct(ModArmorMaterials.REGREIUM), ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> REGREIUM_LEGGINGS = ITEMS.register("regreium_leggings", () -> new ArmorItem(Holder.direct(ModArmorMaterials.REGREIUM), ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final DeferredItem<Item> REGREIUM_BOOTS = ITEMS.register("regreium_boots", () -> new ArmorItem(Holder.direct(ModArmorMaterials.REGREIUM), ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));
